...
const guessNumber = app => {
    ...
    if (answer[0] === NUM_DIGITS) {
        ...
        const response = `You got ${answer[0]} digit in the correct position, and ${answer[1]} digit in the wrong position. You have ${data.numTriesLeft} tries left. Cheat: ${data}`;
        return app.ask(app.buildRichResponse()
                .addSimpleResponse({
